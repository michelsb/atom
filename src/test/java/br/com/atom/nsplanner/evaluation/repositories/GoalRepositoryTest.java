...
public class GoalRepositoryTest {
	...
	protected String initStateClasses[] = new String[] {NamedClasses.HEALINGACTION, NamedClasses.SCALINGACTION, NamedClasses.SCALINGTHRESHOLD, NamedClasses.HEALINGTHRESHOLD, NamedClasses.METRIC};
	protected String initStateOP[] = new String[] {NamedObjectProp.HASNS, NamedObjectProp.HASVNF, NamedObjectProp.HASLEVEL, NamedObjectProp.HASTHRESHOLD, NamedObjectProp.HASMETRIC}; 
	protected String initStateDP[] = new String[] {NamedDataProp.HASLOWSCALEINTHRESHOLDVALUE, NamedDataProp.HASLOWSCALEOUTTHRESHOLDVALUE, 
			...
			NamedDataProp.HASLOWTHRESHOLDVALUE, NamedDataProp.HASMEDIUMTHRESHOLDVALUE, NamedDataProp.HASHIGHTHRESHOLDVALUE, NamedDataProp.HASMEMBERVNFINDEX};
	
	public GoalRepositoryTest(OntologyManager ontomanager) {
